    ...
    ***********************************-->
    <div id="main-wrapper">
            ...
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="driver.html" aria-expanded="false"><i
                                class="icon icon-single-04"></i><span class="nav-text">Driver</span></a>
                                <ul aria-expanded="false">
                                    <li><a href="{{ route('pending.index') }}">Pending Driver</a></li>
                                    <li><a href="{{ route('allDriver.index') }}">All Driver</a></li>
                                    <li><a href="{{ route('reportDriver.index') }}">Driver Report</a></li>
                                </ul>
                    </li>
                </ul>
            </div>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="#" target="_blank">OTOGO</a> 2024</p>A
            </div>
        </div>
        <!--**********************************
            Footer end
